...
1. Clone project in STS from github repository https://github.com/Santosh-1982/Aggregator-Service.git
...
3. Update application.properties file which is located on path src/main/resources
	...
	b. update following properties to replace localhost with host-ip/host-name as per docker container 
           pricing.api.base.url=http://localhost:8080/pricing?q=
           tracking.api.base.url=http://localhost:8080/track?q=
           shipment.api.base.url=http://localhost:8080/shipments?q=

3. Run as Spring Boot Application

4. Open Postman and test aggregator-service api hitting following end point
	http://localhost:8787/v1/aggregation-api-service?pricing=CN,NL&track=123456891,109347263&shipments=123456891,109347263
